        ...
        foreach ($cartArray as $item) {
            ...
            echo '
                    <tr>
                        ...
                        <td>
                        <h5 style="text-align: right;"> ',$item[2],'.00 $</h5>
                        </td>
                        <td>
                            <form style="float:right;" method="post" class="row contact_form">
                            <input id="article" name="article" type="hidden" value="',$item[0],'">
                            <button type="submit" value="Retirer" style="margin:0px" class="primary-btn small">Retirer du panier</button>
                            </form>
                        </td>
                    </tr>';
          }
?>
                            <tr>
                                ...
                                <td>
                                <h5 style="text-align: right;">Prix Total:    <?php echo $total,'.00 $'; ?></h5>
                                </td>
                                <td>
                            ...
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div style="float:right;" class="checkout_btn_inner d-flex align-items-center">
                                        <a class="gray_btn" href="index.html">Retour à l'Accueil</a>
