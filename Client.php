<?php     
    ...
    $requete2="SELECT * FROM user where Login = '$username' and Pass = '$password'";
    ...
    if($result->rowCount()==1){
        ...
        <h1>Merci pour votre message!</h1>
            ...
            <button style="margin: 50px;" onclick="window.location.href = \'login.php\';" class="primary-btn">Retour Au Accueil</button> </div>';
    }
?>
<!DOCTYPE html>
            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        <a href="index.html">Compte<span class="lnr lnr-arrow-right"></span></a>
                        <a href="Client.php">Données</a>
                    </nav>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <form class="row contact_form" action="" method="post" >
                            ...
                            <div class="col-md-12 form-group p_star">
                                <input type="text" required class="form-control" name="login" value=<?php echo $login; ?>></li>
                            </div>
                            <h5>Mot de Passe:</h5>
                            <div class="col-md-12 form-group p_star">
                                <input type="text" required class="form-control" name="pwd" value=<?php echo $pwd; ?>></li>
                            </div>
                            <div class="col-md-12 form-group p_star">
                        ...
                        <div class="col-md-12 form-group p_star">
                            <form class="row contact_form" action="" method="POST">
                                ...
                                <button type="submit" value="submit" class="primary-btn">Supprimer Compte</button>
                            </form>
                        </div>
                        </div>
                    </div>
...
<?php
    if(isset($_POST['delete'])){
        $ins = $idcom->prepare("DELETE FROM user WHERE Login = '$username' and Pass = '$password'"); 
    ...
    if(isset($_POST['update'])){
        $ins = $idcom->prepare("UPDATE user SET Login=:log, Pass=:pass 
        WHERE Login = '$username' and Pass = '$password'");
        $ins->bindValue(':log', $_POST['login']);
        $ins->bindValue(':pass', $_POST['pwd']);
        $ins->execute();
        $idcom=null;
    }
